    ...
    <section class="sidebar">
        <ul class="sidebar-menu">            
            ...
            <li class="treeview {{ Request::segment(2) == 'newscate' || Request::segment(2) == 'news' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">            
                    <li class="{{ Request::segment(2) == 'newscate' ? 'active' : '' }}"><a href="backend/newscate?type=cong-trinh"><i class="fa fa-circle-o"></i> <span>Danh mục</span></a></li>
                    <li class=""><a href="backend/news?type=cong-trinh"><i class="fa fa-circle-o"></i> <span>Danh sách</span></a></li>                   
                </ul>
            </li>
